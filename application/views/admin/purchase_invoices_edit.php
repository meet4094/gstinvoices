...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
    ...
    <div class="page-container">
        <?php $iData['SelectedMenu'] = array("MainMenu" => "purchaseinvoices", "SubMenu" => "purchaseinvoices"); ?>
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                <!-- BEGIN PAGE HEADER-->
                <!-- BEGIN PAGE TITLE-->
                <h3 class="page-title"> Edit Purchase Invoice
                    <small>form</small>
                </h3>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet-body form">
                                <?php if (isset($statuscode) && $statuscode == 0) { ?>
                                    <div class="alert alert-danger">
                                        <strong>Error!</strong> Failed to edit Purchase Invoice. Please try again.
                                    </div>
                                <?php } elseif (isset($statuscode) && $statuscode == 1) { ?>
                                    <div class="alert alert-success">
                                        <strong>Success!</strong> A Purchase Invoice has been edited.
                                    </div>
                                <?php } ?>
                                <form action="<?php echo BASE_URL . "admin/purchase_invoice/edit/" . $edit_purchase_invoices['id']; ?>" role="form" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="alert alert-danger display-hide">
                                        <button class="close" data-close="alert"></button> You have some form errors. Please check below.
                                    </div>
                                    <input type="hidden" value="<?php echo $edit_purchase_invoices['id']; ?>" name="id">
                                    <div class="form-body">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control name" name="user_id">
                                                    <?php foreach ($users as $key => $user) { ?>
                                                        <option <?php if ($user['uid'] == $edit_purchase_invoices['user_id']) {
                                                                    echo 'selected';
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control name" name="shopper_id">
                                                    <?php foreach ($shoppers as $key => $shopper) { ?>
                                                        <option <?php if ($shopper['id'] == $edit_purchase_invoices['shopper_id']) {
                                                                    echo 'selected';
                                                                } ?> value="<?php echo $shopper['id']; ?>"><?php echo $shopper['trade_name']; ?></option>
                                                    <?php } ?>
                                                </select>
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="date" value="<?php echo ($edit_purchase_invoices['invoices_date']) ?>" name="invoices_date" class="form-control" placeholder="Enter invoices date">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" value="<?php echo ($edit_purchase_invoices['invoices_no']) ?>" name="invoices_no" class="form-control" placeholder="Enter invoices no...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="<?php echo ($edit_purchase_invoices['gst']) ?>" name="gst_number" class="form-control" placeholder="Enter your GST number...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" value="<?php echo ($edit_purchase_invoices['sub_total']) ?>" name="sub_total" class="form-control" placeholder="Enter sub total...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" value="<?php echo ($edit_purchase_invoices['product_sgst']) ?>" name="product_sgst" class="form-control" placeholder="Enter SGST...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" value="<?php echo ($edit_purchase_invoices['product_sgst']) ?>" name="product_sgst" class="form-control" placeholder="Enter CGST...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" value="<?php echo ($edit_purchase_invoices['round_off']) ?>" name="round_off" class="form-control" placeholder="Enter rorund off...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" value="<?php echo ($edit_purchase_invoices['invoices_total']) ?>" name="invoices_total" class="form-control" placeholder="Enter total...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <div class="md-radio-inline">
                                                    <div class="md-radio">
                                                        <input value="0" type="radio" id="radio53" name="is_del" <?php if ($edit_purchase_invoices['is_del'] == 0) {
                                                    ...
                                                    <div class="md-radio has-error">
                                                        <input value="1" type="radio" id="radio54" name="is_del" <?php if ($edit_purchase_invoices['is_del'] == 1) {
                                                                                                                        echo 'checked="checked"';
                                                                                                                    } ?> class="md-radiobtn">
                                                        <label for="radio54">
                                                            <span></span>
