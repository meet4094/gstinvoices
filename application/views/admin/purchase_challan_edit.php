...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
    ...
    <div class="page-container">
        <?php $iData['SelectedMenu'] = array("MainMenu" => "purchasechallan", "SubMenu" => "purchasechallan"); ?>
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                <!-- BEGIN PAGE HEADER-->
                <!-- BEGIN PAGE TITLE-->
                <h3 class="page-title"> Edit Purchase Challan
                    <small>form</small>
                </h3>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet-body form">
                                <?php if (isset($statuscode) && $statuscode == 0) { ?>
                                    <div class="alert alert-danger">
                                        <strong>Error!</strong> Failed to edit Purchase Challan. Please try again.
                                    </div>
                                <?php } elseif (isset($statuscode) && $statuscode == 1) { ?>
                                    <div class="alert alert-success">
                                        <strong>Success!</strong> A Purchase Challan has been edited.
                                    </div>
                                <?php } ?>
                                <form action="<?php echo BASE_URL . "admin/purchase_challan/edit/" . $edit_purchase_challan['id']; ?>" role="form" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="alert alert-danger display-hide">
                                        <button class="close" data-close="alert"></button> You have some form errors. Please check below.
                                    </div>
                                    <input type="hidden" value="<?php echo $edit_purchase_challan['id']; ?>" name="id">
                                    <div class="form-body">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control name" name="user_id">
                                                    <?php foreach ($users as $key => $user) { ?>
                                                        <option <?php if ($user['uid'] == $edit_purchase_challan['user_id']) {
                                                                    echo 'selected';
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control name" name="shopper_id">
                                                    <?php foreach ($shoppers as $key => $shopper) { ?>
                                                        <option <?php if ($shopper['id'] == $edit_purchase_challan['shopper_id']) {
                                                                    echo 'selected';
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="date" value="<?php echo ($edit_purchase_challan['challan_date']) ?>" name="challan_date" class="form-control" placeholder="Enter invoices date">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <div class="md-radio-inline">
                                                    <div class="md-radio">
                                                        <input value="0" type="radio" id="radio53" name="is_del" <?php if ($edit_purchase_challan['is_del'] == 0) {
                                                    ...
                                                    <div class="md-radio has-error">
                                                        <input value="1" type="radio" id="radio54" name="is_del" <?php if ($edit_purchase_challan['is_del'] == 1) {
                                                                                                                        echo 'checked="checked"';
                                                                                                                    } ?> class="md-radiobtn">
                                                        <label for="radio54">
                                                            <span></span>
