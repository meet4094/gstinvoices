                            ...
                            <div class="portlet-body">
                                <div class="table-container">
                                    <div class="table-actions-wrapper">
                                        <a href="<?php echo BASE_URL . "admin/report/overall_profit"; ?>" target="_blank" class="btn btn-sm yellow">
                                            <i class="fa fa-eye"></i>
                                            <span class="title">Overall Profit</span>
                                        </a>
                                        <a href="<?php echo BASE_URL . "admin/report/overall_stocks"; ?>" target="_blank" class="btn btn-sm green">
                                            <i class="fa fa-eye"></i>
                                            <span class="title">Overall Stocks</span>
                                        </a>
                                    </div>
                                    <table class="table table-striped table-bordered table-hover" id="report_list">
                                        <thead>
                                            <tr role="row" class="heading">
                                                <th width="2%"> # </th>
                                                <th width="3%"> Month </th>
                                                <th width="3%"> Buy Gst </th>
                                                <th width="5%"> Buy Amount </th>
                                                <th width="3%"> Sell Gst </th>
                                                <th width="5%"> Sell Amount </th>
                                                <th width="3%"> Profit Gst </th>
                                                <th width="3%"> Profit Amount </th>
