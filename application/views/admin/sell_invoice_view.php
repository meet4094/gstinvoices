    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
        ...
        <div class="page-container">
            <?php $iData['SelectedMenu'] = array("MainMenu" => "sellinvoices", "SubMenu" => ""); ?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <!-- BEGIN PAGE HEADER-->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Sell Invoice
                        <small>listing</small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                                ...
                                <div class="portlet-body">
                                    <div class="table-container">
                                        <div class="table-actions-wrapper">
                                            <a href="<?php echo BASE_URL . "admin/sell_invoice/add"; ?>" class="btn btn-sm elegant">
                                                <i class="fa fa-plus"></i>
                                                <span class="title">Add Sell Invoice</span>
                                            </a>
                                        </div>
                                        <table class="table table-striped table-bordered table-hover" id="sellinvoiceList">
                                            <thead>
                                                <tr role="row" class="heading">
                                                    <th width="2%"> # </th>
                                                    <th width="5%"> Customer Name </th>
                                                    <th width="3%"> Invoices Date </th>
                                                    <th width="3%"> Invoices No </th>
                                                    <th width="3%"> Total</th>
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td>
                                                        <input type="date" class="form-control date-picker form-filter" name="invoices_date">
                                                    </td>
                                                    <td> </td>
                                                    <td> </td>
                                                    <td> </td>
                ...
                var handleRecords = function() {
                    ...
                    grid.init({
                        ...
                        dataTable: {
                            ...
                            "responsive": true,
                            "ajax": {
                                "url": "<?php echo BASE_URL; ?>admin/sell_invoice/sellinvoice_list/<?php echo $id; ?>", // ajax source
                            }
                        }
                    });
                }
