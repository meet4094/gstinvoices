    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                <!-- BEGIN PAGE HEADER-->
                <!-- BEGIN PAGE TITLE-->
                <h3 class="page-title"> Add Purchase Invoice Payment
                    <small>form</small>
                </h3>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet-body form">
                                <?php if (isset($statuscode) && $statuscode == 0) { ?>
                                    <div class="alert alert-danger">
                                        <strong>Error!</strong> Failed to add Purchase Invoice Payment. Please try again.
                                    </div>
                                ...
                                <?php } ?>
                                <form action="<?php echo BASE_URL . "admin/purchase_invoices_payment/add/" . $invoicesLists['id']; ?>" role="form" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" readonly class="form-control" value="<?php echo $invoicesLists['invoices_no'] ?>">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <div class="md-radio-inline">
                                                    <div class="md-radio has-success">
                                                        <input value="1" type="radio" id="radio53" name="payment_mode" checked="checked" class="md-radiobtn">
                                                        <label for="radio53">
                                                            <span></span>
                                                    ...
                                                    <div class="md-radio has-error">
                                                        <input value="2" type="radio" id="radio54" name="payment_mode" class="md-radiobtn">
                                                        <label for="radio54">
                                                            <span></span>
                                                            <span class="check"></span>
                                                    ...
                                                    <div class="md-radio has-warning">
                                                        <input value="3" type="radio" id="radio55" name="payment_mode" class="md-radiobtn">
                                                        <label for="radio55">
                                                            <span></span>
                                                            <span class="check"></span>
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-5">
                                                <input type="date" name="payment_date" class="form-control" placeholder="Enter payment date">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" readonly value="<?php echo $transferamount ?>">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" name="amount" class="form-control" placeholder=" ₹ Enter amount..." value="<?php echo ($invoicesLists['invoices_total'] - $transferamount) ?>">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="bank_detail" class="form-control" placeholder="Enter bank detail">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="transaction_detail" class="form-control" placeholder="Enter transaction detail">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                    </div>
