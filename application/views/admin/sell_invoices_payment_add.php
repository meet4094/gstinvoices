    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                <!-- BEGIN PAGE HEADER-->
                <!-- BEGIN PAGE TITLE-->
                <h3 class="page-title"> Add Sell Invoice Payment
                    <small>form</small>
                </h3>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet-body form">
                                <?php if (isset($statuscode) && $statuscode == 0) { ?>
                                    <div class="alert alert-danger">
                                        <strong>Error!</strong> Failed to add Sell Invoice Payment. Please try again.
                                    </div>
                                ...
                                <?php } ?>
                                <form action="<?php echo BASE_URL . "admin/sell_invoices_payment/add/" . $invoicesLists['id']; ?>" role="form" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" readonly value="<?php echo $invoicestotal ?>">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" name="amount" class="form-control" value="<?php echo ($invoicesLists['invoices_total'] - $invoicestotal) ?>" placeholder=" ₹ Enter amount...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
