                        ...
                        <div class="col-md-12">
                            ...
                            <div class="invoice-box">
                                <table cellpadding="0" cellspacing="0">
                                    <tr class="top">
                                        <td>
                                            <h1 class="margin-bottom-5 margin-top-10"><?php echo $userDetailes['trade_name']; ?></h1>
                                ...
                                <div class="line-text">
                                    <h1 class="line"></h1>
                                    <h3 class="text">INVOICE</h2>
                                        <h1 class="line1"></h1>
                                </div>
                                <div class="col-lg-12">
                                    <div class="row invoiceto">
                                        <div class="col-lg-6 col-md-6">
                                            <h2>Invoice to:</h2>
                                            <!-- <hr> -->
                                            <h3 class="customer"><?php echo $sellinvoiceDetailes['customertradename'] ?></h3>
                                            <p class="address"><?php echo $sellinvoiceDetailes['customeraddress'] ?></p>
                                            <div class="details">
                                                <h5>Place of Supply : <?php echo $sellinvoiceDetailes['customerplaceofsupply'] ?></h5>
                                            </div>
                                            <div class="details">
                                                <h5>GSTIN No : <?php echo $sellinvoiceDetailes['customergstnumber'] ?></h5>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 invoicedate" style="margin: 0px;">
                                                <h5 class="bold">Date :<?php echo $sellinvoiceDetailes['invoices_date'] ?></h5>
                                                <h5 class="bold">Invoice No :<?php echo $sellinvoiceDetailes['invoices_no'] ?></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="table">
                                        <table cellpadding="0" cellspacing="0">
                                            ...
                                            <?php foreach ($productDetailes as $key => $productDetaile) { ?>
                                                <tr class="item">
                                                    <td>1.</td>
                                                    <td><?php echo $productDetaile['productname'] ?></td>
                                                    <td><?php echo $productDetaile['product_hsn_sac'] ?></td>
                                                    <td><?php echo $productDetaile['product_quantity'] ?></td>
                                                    <td><?php echo $productDetaile['product_rate'] ?></td>
                                                    <td><?php echo $sellinvoiceDetailes['gst'] ?></td>
                                    ...
                                    <div class="row">
                                        <div class="upper">
                                            <div class="col-lg-6 one">
                                                <div class="gst">
                                                    <h5>GSTIN NO : <?php echo $userDetailes['gst_number'] ?></h5>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 subtotal">
                                                ...
                                                <div class="total">
                                                    <h5><?php echo $sellinvoiceDetailes['sub_total'] ?></h5>
                                                    <h5><?php echo $sellinvoiceDetailes['product_cgst'] ?></h5>
                                                    <h5><?php echo $sellinvoiceDetailes['product_sgst'] ?></h5>
                                                    <h5><?php echo $sellinvoiceDetailes['round_off'] ?></h5>
                                                    <h5><?php echo $sellinvoiceDetailes['invoices_total'] ?></h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="contions">
