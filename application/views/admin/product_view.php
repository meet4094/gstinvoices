    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
        ...
        <div class="page-container">
            <?php $iData['SelectedMenu'] = array("MainMenu" => "product", "SubMenu" => ""); ?>
                                ...
                                <div class="portlet-body">
                                    <div class="table-container">
                                        <div class="table-actions-wrapper">
                                            <a href="<?php echo BASE_URL . "admin/product/add"; ?>" class="btn btn-sm elegant">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="productList">
                                            <thead>
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter" name="product_code">
                                                    </td>
                                                    <td> </td>
                                                    <td>
                ...
                var handleRecords = function() {
                    ...
                    grid.init({
                        ...
                        dataTable: {
                            ...
                            "responsive": true,
                            "ajax": {
                                "url": "<?php echo BASE_URL; ?>admin/product/product_list", // ajax source
                            }
                        }
                    });
                }
