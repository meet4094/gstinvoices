    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                <!-- BEGIN PAGE HEADER-->
                <!-- BEGIN PAGE TITLE-->
                <h3 class="page-title"> Purchase Invoice Payment
                    <small>listing</small>
                </h3>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet-body">
                                <div class="table-container">
                                    <div class="table-actions-wrapper">
                                        <a href="<?php echo BASE_URL . "admin/purchase_invoices_payment/add"; ?>" class="btn btn-sm elegant">
                                            <i class="fa fa-plus"></i>
                                            <span class="title">Add Payment</span>
                                        </a>
                                    </div>
                                    <table class="table table-striped table-bordered table-hover" id="purchaseinvoicepayment_List">
                                        <thead>
                                            <tr role="row" class="heading">
                                                <th width="2%"> # </th>
                                                <th width="5%"> Shopper </th>
    ...
    <script type="text/javascript">
        var TableDatatablesAjax = function() {
            ...
            var handleRecords = function() {
                ...
                grid.init({
                    src: $("#purchaseinvoicepayment_List"),
                    ...
                    dataTable: {
                        ...
                        "responsive": true,
                        "ajax": {
                            "url": "<?php echo BASE_URL; ?>admin/purchase_invoices_payment/purchaseinvoicepayment_List", // ajax source
                        }
                    }
                });
            }
