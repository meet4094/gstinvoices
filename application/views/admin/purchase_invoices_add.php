    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                <!-- BEGIN PAGE HEADER-->
                <!-- BEGIN PAGE TITLE-->
                <h3 class="page-title"> Add Purchase Invoice
                    <small>form</small>
                </h3>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet-body form">
                                <?php if (isset($statuscode) && $statuscode == 0) { ?>
                                    <div class="alert alert-danger">
                                        <strong>Error!</strong> Failed to add Purchase Invoice. Please try again.
                                    </div>
                                <?php } elseif (isset($statuscode) && $statuscode == 1) { ?>
                                    <div class="alert alert-success">
                                        <strong>Success!</strong> A Purchase Invoice has been added.
                                    </div>
                                <?php } ?>
                                <form action="<?php echo BASE_URL . "admin/purchase_invoice/add"; ?>" role="form" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control name" name="shopper_id">
                                                    <?php foreach ($shoppers as $key => $shopper) { ?>
                                                        <option value="<?php echo $shopper['id']; ?>"><?php echo $shopper['trade_name']; ?></option>
                                                    <?php } ?>
                                                </select>
                                                <div class="form-control-focus"> </div>
                                            </div>
