...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
    ...
    <div class="page-container">
        <?php $iData['SelectedMenu'] = array("MainMenu" => "customer", "SubMenu" => "customer"); ?>
                            ...
                            <div class="portlet-body form">
                                <?php if (isset($statuscode) && $statuscode == 0) { ?>
                                    <div class="alert alert-danger">
                                        <strong>Error!</strong> Failed to edit Customer. Please try again.
                                    </div>
                                <?php } elseif (isset($statuscode) && $statuscode == 1) { ?>
                                    <div class="alert alert-success">
                                        <strong>Success!</strong> A Customer has been edited.
                                    </div>
                                <?php } ?>
                                <form action="<?php echo BASE_URL . "admin/customer/edit/" . $edit_customer['id']; ?>" role="form" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="alert alert-danger display-hide">
                                        <button class="close" data-close="alert"></button> You have some form errors. Please check below.
                                    </div>
                                    <input type="hidden" value="<?php echo $edit_customer['id']; ?>" name="id">
                                    <div class="form-body">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control name" name="user_id">
                                                    <?php foreach ($users as $key => $user) { ?>
                                                        <option <?php if ($edit_customer['user_id'] ==  $user['uid']) {
                                                                    echo 'selected';
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="<?php echo ($edit_customer['trade_name']) ?>" name="tradename" class="form-control" placeholder="Enter trade name">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="<?php echo ($edit_customer['leagel_name']) ?>" name="dealer_name" class="form-control" placeholder="Enter your dealer name...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="<?php echo ($edit_customer['dealer_name']) ?>" name="leagel_name" class="form-control" placeholder="Enter your dealer name...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="<?php echo ($edit_customer['place_of_supply']) ?>" name="place_of_supply" class="form-control" placeholder="Enter your dealer name...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="<?php echo ($edit_customer['gst_number']) ?>" name="gst_number" class="form-control" placeholder="Enter your GST numger...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" value="<?php echo ($edit_customer['mobile_number']) ?>" name="mobile_number" class="form-control" placeholder="Enter your mobile numger...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="<?php echo ($edit_customer['address']) ?>" name="address" class="form-control" placeholder="Enter your addess...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <div class="md-radio-inline">
                                                    <div class="md-radio">
                                                        <input value="0" type="radio" id="radio53" name="is_del" <?php if ($edit_customer['is_del'] == 0) {
                                                    ...
                                                    <div class="md-radio has-error">
                                                        <input value="1" type="radio" id="radio54" name="is_del" <?php if ($edit_customer['is_del'] == 1) {
                                                                                                                        echo 'checked="checked"';
                                                                                                                    } ?> class="md-radiobtn">
                                                        <label for="radio54">
                                                            <span></span>
