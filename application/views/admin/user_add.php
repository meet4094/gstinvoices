                            ...
                            <div class="portlet-body form">
                                ...
                                <?php } elseif (isset($statuscode) && $statuscode == 1) { ?>
                                    <div class="alert alert-success">
                                        <strong>Success!</strong> A User has been added.
                                    </div>
                                <?php } ?>
                                <form action="<?php echo BASE_URL . "admin/user/add"; ?>" role="form" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="trade_name" class="form-control" placeholder="Enter trade name">
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="leagal_name" class="form-control" placeholder="Enter your dealer name...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="gst_number" class="form-control" placeholder="Enter your GST number...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="address" class="form-control" placeholder="Enter your addess...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <div class="md-radio-inline">
                                                    <div class="md-radio">
                                                        <input value="0" type="radio" id="radio53" name="is_create_profile" class="md-radiobtn">
                                                        <label for="radio53">
                                                            <span></span>
                                                    ...
                                                    <div class="md-radio has-error">
                                                        <input value="1" type="radio" id="radio54" name="is_create_profile" checked="checked" class="md-radiobtn">
                                                        <label for="radio54">
                                                            <span></span>
                                                            <span class="check"></span>
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <div class="md-radio-inline">
                                                    <div class="md-radio">
                                                        <input value="0" type="radio" id="radio55" name="is_active" checked="checked" class="md-radiobtn">
                                                        <label for="radio55">
                                                            <span></span>
                                                            <span class="check"></span>
                                                    ...
                                                    <div class="md-radio has-error">
                                                        <input value="1" type="radio" id="radio56" name="is_active" class="md-radiobtn">
                                                        <label for="radio56">
                                                            <span></span>
                                                            <span class="check"></span>
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <div class="md-radio-inline">
                                                    <div class="md-radio">
                                                        <input value="0" type="radio" id="radio57" name="is_del" checked="checked" class="md-radiobtn">
                                                        <label for="radio57">
                                                            <span></span>
                                                            <span class="check"></span>
                                                    ...
                                                    <div class="md-radio has-error">
                                                        <input value="1" type="radio" id="radio58" name="is_del" class="md-radiobtn">
                                                        <label for="radio58">
                                                            <span></span>
                                                            <span class="check"></span>
