...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                <!-- BEGIN PAGE HEADER-->
                <!-- BEGIN PAGE TITLE-->
                <h3 class="page-title"> Add Sell Invoice
                    <small>form</small>
                </h3>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet-body form">
                                <?php if (isset($statuscode) && $statuscode == 0) { ?>
                                    <div class="alert alert-danger">
                                        <strong>Error!</strong> Failed to add Sell Invoice. Please try again.
                                    </div>
                                <?php } elseif (isset($statuscode) && $statuscode == 1) { ?>
                                    <div class="alert alert-success">
                                        <strong>Success!</strong> A Sell Invoice has been added.
                                    </div>
                                <?php } ?>
                                <form action="<?php echo BASE_URL . "admin/sell_invoice/add"; ?>" role="form" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-body">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control name" name="user_id">
                                                    <?php foreach ($users as $key => $user) { ?>
                                                        <option value="<?php echo $user['uid']; ?>"><?php echo $user['trade_name']; ?></option>
                                                    <?php } ?>
                                                </select>
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control name" name="customer_id">
                                                    <?php foreach ($customers as $key => $customer) { ?>
                                                        <option value="<?php echo $customer['id']; ?>"><?php echo $customer['trade_name']; ?></option>
                                                    <?php } ?>
                                                </select>
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="date" name="invoices_date" class="form-control date-picker" placeholder="Enter invoices date" data-date-format="yyyy-mm-dd">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" name="invoices_no" class="form-control" placeholder="Enter invoices no...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><input type="number" name="product_hsn_sac[]" class="form-control"></td>
                                                            <td><input type="number" name="product_quantity[]" class="form-control"></td>
                                                            <td><input type="number" name="product_rate[]" class="form-control"></td>
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" name="sub_total" class="form-control" placeholder="Enter sub total...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" name="product_sgst" class="form-control" placeholder="Enter SGST...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" name="product_cgst" class="form-control" placeholder="Enter CGST...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" name="round_off" class="form-control" placeholder="Enter rorund off...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" name="invoices_total" class="form-control" placeholder="Enter total...">
                                                <div class="form-control-focus"> </div>
                                            </div>
                                        </div>
                                        <div class="form-group form-md-line-input">
    ...
    <script type="text/javascript">
        ...
        function addBox() {
            ...
            textBox = '<tr>' +
                '<td></td>' +
                '<td><select class="form-control" name="product_id[]"><?php foreach ($products as $key => $product) { ?><option value="<?php echo $product['id']; ?>"><?php echo $product['product_name']; ?></option><?php } ?></select></td>' +
                '<td><input type="number" name="product_hsn_sac[]" class="form-control"></td>' +
                '<td><input type="number" name="product_quantity[]" class="form-control"></td>' +
                '<td><input type="number" name="product_rate[]" class="form-control"></td>' +
                '<td><input type="number" name="total_amount[]" class="form-control"></td>' +
                '<td><input type="button" value="-" onclick ="removeBox(this)" class="add btn btn-danger"></td></tr>';
