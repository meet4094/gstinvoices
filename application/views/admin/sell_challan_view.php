    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
        ...
        <div class="page-container">
            <?php $iData['SelectedMenu'] = array("MainMenu" => "sellchallan", "SubMenu" => ""); ?>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <!-- BEGIN PAGE HEADER-->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title">Sell Challan
                        <small>listing</small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                                ...
                                <div class="portlet-body">
                                    <div class="table-container">
                                        <div class="table-actions-wrapper">
                                            <a href="<?php echo BASE_URL . "admin/sell_challan/add"; ?>" class="btn btn-sm elegant">
                                                <i class="fa fa-plus"></i>
                                                <span class="title">Add Sell Challan</span>
                                            </a>
                                        </div>
                                        <table class="table table-striped table-bordered table-hover" id="sellchallan_list">
                                            <thead>
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter" name="customer_id">
                                                    </td>
                                                    <td> </td>
                                                    <td>
                ...
                var handleRecords = function() {
                    ...
                    grid.init({
                        ...
                        dataTable: {
                            ...
                            "responsive": true,
                            "ajax": {
                                "url": "<?php echo BASE_URL; ?>admin/sell_challan/sellchallan_list/<?php echo $id; ?>", // ajax source
                            }
                        }
                    });
                }
