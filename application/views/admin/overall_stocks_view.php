                    ...
                    <div class="col-md-12">
                        ...
                        <div class="invoice-box">
                            ...
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <?php foreach ($produts as $key => $product) { ?>
                                    <tr class="item">
                                        <td class="text-center"><?php echo $product['id']; ?></td>
                                        <td class="text-center"><?php echo $product['product_name']; ?></td>
                                        <td class="text-center"><?php echo $product['buyproductQty']; ?></td>
                                        <td class="text-center"><?php echo $product['sellproductQty']; ?></td>
                                        <td class="text-center"><?php echo $product['remain']; ?></td>
                                    </tr>
                                <?php } ?>
                            </table>
                        </div>
